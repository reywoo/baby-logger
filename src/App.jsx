...
const translations = {
  zh: {
    ...
    chineseTextLabel: '中文描述 (Chinese Description)',
    englishTextLabel: '英文描述 (English Description)',
    notesLabel: '备注 Notes (支持中/英文或混合)',
    cancelBtn: '取消',
    saveBtn: '确认保存',
  ...
  en: {
    ...
    chineseTextLabel: 'Chinese Description',
    englishTextLabel: 'English Description',
    notesLabel: 'Notes (CN/EN/Mixed)',
    cancelBtn: 'Cancel',
